...
"""
    ...
    # destination should only specify base directory - xforms.save_analysis
    # adds on recording name, modelspec name, etc.
    destination = '/auto/data/tmp/modelspecs/{0}/'.format(batch)
